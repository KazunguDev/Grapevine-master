...
class _ProfileState extends State<Profile> {
  Future<void> getInitialDetails() async {
    ...
    String dateofbirth=(await databaseReference.child(firebaseid).child("dateofbirth").once()).snapshot.value.toString();
    String name=(await databaseReference.child(firebaseid).child("name").once()).snapshot.value.toString();
    String desc=(await databaseReference.child(firebaseid).child("desc").once()).snapshot.value.toString();
    String skills=(await databaseReference.child(firebaseid).child("dateofbirth").once()).snapshot.value.toString();
    String email=(await databaseReference.child(firebaseid).child("email").once()).snapshot.value.toString();
    String phoneno=(await databaseReference.child(firebaseid).child("phoneno").once()).snapshot.value.toString();
    setState(()  {
      if(dateofbirth!=null)
